...
export const DEF_S: GesSettings = {
  ...
  selInv: 0,
  notes: [
    "Detay mühendislik tasarım aşamasında metraj/adet yerleşim farklılıkları söz konusu olabilecektir.",
    "Dağıtım merkezi ve içindeki hücreler teklife dahildir.",
    "Trafolar AL sargılıdır.",
    "Çakım olarak düşünülmüştür.",
    "Teklifimizin iletildiği tarihten itibaren Türkiye ve Çin'de artış söz konusu olan her türlü vergi vb. değişiminde teklifimiz geçerli değildir.",
    "Hafriyat ve ENH dahil değildir.",
    "Saha içi yollar mıcır olarak düşünülmüştür.",
    "Yangın algılama sistemi düşünülmemiştir.",
  ],
  risks: [],
  customerInsights: [],
  // Fizibilite
