              ...
              return (
                <Group key={dm.id}>
                  <Group x={dm.x} y={dm.y} rotation={dm.dirDeg || 0} draggable={mode === "edit" || mode === "move"} onDragEnd={(e) => moveDormer(dm.id, e.target.x(), e.target.y())}>
                    ...
                    {/* iç çizgiler — 3B ile birebir: sırt (genişlik ekseni, y=ry) + iki eğim */}
                    <Line points={[-hw, ry, hw, ry]} stroke="#7c3aed" strokeWidth={1.8 / scale} listening={false} />
                    <Line points={[-hw, ry, -hw, hd]} stroke="#7c3aed" strokeWidth={0.9 / scale} dash={[3 / scale, 3 / scale]} listening={false} />
                    <Line points={[hw, ry, hw, hd]} stroke="#7c3aed" strokeWidth={0.9 / scale} dash={[3 / scale, 3 / scale]} listening={false} />
                    <Line points={[-hw, ry, -hw, -hd]} stroke="#7c3aed" strokeWidth={0.9 / scale} dash={[3 / scale, 3 / scale]} listening={false} />
                    <Line points={[hw, ry, hw, -hd]} stroke="#7c3aed" strokeWidth={0.9 / scale} dash={[3 / scale, 3 / scale]} listening={false} />
                  </Group>
