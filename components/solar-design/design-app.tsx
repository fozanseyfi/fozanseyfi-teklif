...
function Editor() {
  ...
  function addDormer() {
    update((d) => {
      ...
      m.dormers.push({ id: newMassId(), x: cx, y: cy, widthM: 3, depthM: 2, ridgeHalfM: 0.5, dirDeg: 0, type: "gable" });
    }, true);
    setTool("move");
              ...
              <div className="space-y-2 border-t pt-2">
                ...
                {active.dormers.length === 0 ? (
                  ...
                  <div key={dm.id} className="space-y-1 rounded-md border border-slate-200 p-2">
                    ...
                    <p className="text-[9.5px] text-slate-400">Saçak ana bina saçağıyla aynı kotta; eğim binadan otomatik. Köşelerden boyutlandır, turuncudan döndür.</p>
                    <div className="flex items-center gap-2">
