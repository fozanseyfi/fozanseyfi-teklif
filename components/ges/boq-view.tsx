...
export function BoQView({
  ...
  function handlePrint() {
    ...
    // Marka renderlama: kullanici Profilim'de hangi unsurlari acmissa onlar
    // gozukur. Toggle kapaliysa default emerald BoQ kapagi.
    ...
    <style>
      *{margin:0;padding:0;box-sizing:border-box}
      ...
      .cover{background:${ctx.coverGradient};color:#fff;padding:22px 24px 18px;border-radius:0 0 12px 12px;margin-bottom:6px}
      ...
      .accent-bar{height:3px;background:${ctx.accentGradient}}
      ...
      .group-row td{background:#f8fafc;border-top:2px solid ${ctx.primary};border-bottom:1px solid #e2e8f0;font-size:10.5px;color:${ctx.primaryDark};padding:6px 8px;font-weight:800}
      ...
      .subtotal td{background:#f1f5f9;font-weight:800;color:${ctx.primaryDark};border-top:2px solid ${ctx.primary};padding:6px 8px}
      .total-row td{background:#e2e8f0;font-weight:900;color:${ctx.primaryDark};border-top:3px solid ${ctx.primary};font-size:11.5px;padding:7px 8px}
    ...
    ${watermarkHtml(ctx, firmName)}
    <div class="cover">
      ${brandRowHtml(ctx, firmName)}
      <div class="top">
        <div>
    ...
    ${brandFooterHtml(ctx, firmName, userEmail, docId)}
    </body></html>`;
